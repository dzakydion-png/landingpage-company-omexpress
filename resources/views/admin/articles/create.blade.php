...
@section('content')
    ...
    <form class="card form-grid" method="post" action="{{ route('admin.articles.store') }}">
        ...
        <div>
            ...
            <input id="slug" name="slug" type="text" value="{{ old('slug') }}" placeholder="contoh-judul-artikel">
        ...
        <div class="grid cols-2">
            ...
            <div>
                ...
                <input id="meta_keywords" name="meta_keywords" type="text" value="{{ old('meta_keywords') }}" placeholder="logistik, cargo, ongkir">
            </div>
        </div>
        <div>
            <label for="meta_description">Meta Description</label>
            <textarea id="meta_description" name="meta_description" maxlength="160">{{ old('meta_description') }}</textarea>
